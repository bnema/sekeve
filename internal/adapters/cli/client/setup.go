...
// WithGUI wraps a cobra command to wire adapters (GUI, crypto, notification)
// before execution. This keeps adapter imports in the client package (composition
// root), away from root/server.
func WithGUI(cmd *cobra.Command) *cobra.Command {
	...
	cmd.PreRunE = func(cmd *cobra.Command, args []string) error {
		...
		ctx = cliconfig.WithCrypto(ctx, adaptercrypto.NewGPGAdapter())
